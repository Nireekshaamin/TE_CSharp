...
/// <summary>
/// Delegate -> reference type -> hold the reference of a particular method -> Runtime
/// Delegate -> class -> using System;
/// Delegates -> 2 types -> Single-cast and Multi-cast
/// </summary>
namespace TE_CSharp
{
    /// <summary>
    ...
    public delegate void EmpDelegate4(int empid, string empname);
    /// <summary>
    /// Multi-cast delegate working - hold the reference of more than one method
    /// </summary>
    /// <param name="empid"></param>
    /// <param name="empname"></param>
    public delegate void EmpDelegate5(int empid, string empname);

    /// <summary>
    /// Employees - 2 methods
    /// </summary>
    public class Employees5
    {
        /// <summary>
        /// GetITLeadDetails
        /// </summary>
    ...
    /// </summary>
    internal class Delegates3
    {
        public static void Main()
        {
            //instance for the class
            Employees5 employees = new Employees5();
